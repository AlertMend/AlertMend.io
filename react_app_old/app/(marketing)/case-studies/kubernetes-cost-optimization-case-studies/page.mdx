...
export const caseStudy = {
  author: { name: "Rajnish Sharma", src: "/avatar.jpeg", designation: "Founder and CEO of Wareflex" },
  title: "WareFlex Cut GKE Costs by 50% Using AlertMend’s AI-Powered Optimization.",
  description: "AlertMend helped us take control of our Kubernetes costs without adding any manual effort. Within a week, we cut GKE expenses in half, cleaned up unused storage, and right-sized workloads — all without touching a single YAML file. It’s like having an AI-powered infra co-pilot that just works.",
  image:
...
# WareFlex Cut GKE Costs by 50% Using AlertMend’s AI-Powered Optimization
...
|            | **Total Compute Cost** | **Total Storage Cost** | **% Saved (Compute)** | **% Saved (Storage)** |
|------------|------------------------|-------------------------|------------------------|------------------------|
| **Before** | $719.42/mo             | $407.66/mo              | —                      | —                      |
| **After**  | $422.42/mo             | $25.66/mo               | 41.27%                 | 93.71%                 |
