...
export const blog = {
  ...
  image: "/img/blogs/Resolving Elasticsearch Virtual Memory Limit Issues for Optimal Performance.png",
};
export const metadata = {
  description: blog.description,
    keywords:
    'Elasticsearch virtual memory limit, fix vm.max_map_count Elasticsearch, Elasticsearch memory error, Elasticsearch kernel parameter tuning, increase vm.max_map_count, Elasticsearch memory configuration, Elasticsearch performance optimization, Elasticsearch out of memory fix, Elasticsearch system requirements, troubleshoot Elasticsearch memory issues, Elasticsearch indexing memory error, Elasticsearch cluster tuning',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-Virtual-Memory-Limit-Issues-for-Optimal-Performance.html',
  },
};
