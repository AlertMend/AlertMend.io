...
export const blog = {
  ...
  image: "/img/blogs/Troubleshooting Elasticsearch Shard Relocation Incidents on Kubernetes: Causes and Solutions.png",
};
...
export const metadata = {
  ...
  description: blog.description,
   keywords:
    'Elasticsearch shard relocation, fix shard relocation Elasticsearch, Elasticsearch shard movement, Elasticsearch Kubernetes troubleshooting, Elasticsearch cluster rebalancing, Elasticsearch node failures, Elasticsearch rebalance shards, shard relocation Kubernetes, Elasticsearch scaling issues, Elasticsearch performance optimization, troubleshoot shard relocation Elasticsearch, Elasticsearch shard allocation, Elasticsearch auto-rebalancing',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-Shard-Relocation-Incidents-on-Kubernetes.html',
  },
};
