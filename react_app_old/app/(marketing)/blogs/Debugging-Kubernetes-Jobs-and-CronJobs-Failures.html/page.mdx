...
export const metadata = {
  ...
  keywords:
    'Kubernetes Jobs troubleshooting, Kubernetes CronJobs troubleshooting, Kubernetes job failed, Kubernetes CronJob not running, job pod CrashLoopBackOff, Kubernetes job stuck pending, CronJob missed schedule, Kubernetes concurrencyPolicy, activeDeadlineSeconds, startingDeadlineSeconds, Kubernetes job best practices, Kubernetes job debugging, Kubernetes job monitoring',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
   ...
   alternates: {
    canonical: 'https://www.alertmend.io/blogs/Debugging-Kubernetes-Jobs-and-CronJobs-Failures.html',
  },
};
