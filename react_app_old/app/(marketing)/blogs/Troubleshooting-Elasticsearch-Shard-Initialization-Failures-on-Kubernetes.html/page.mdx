...
export const blog = {
  ...
  image:
    "/img/blogs/Troubleshooting Elasticsearch Shard Initialization Failures on Kubernetes: Causes and Fixes.png",
};
...
export const metadata = {
  ...
  keywords:
    'Elasticsearch shard initialization failure fix, troubleshoot Elasticsearch initializing shards, Elasticsearch shards not initializing Kubernetes, fix unassigned shards in Elasticsearch, Elasticsearch shard allocation issues, Elasticsearch cluster red yellow state fix, Kubernetes Elasticsearch pod crash troubleshooting, Elasticsearch shard recovery on Kubernetes, Elasticsearch initializing shards stuck, Elasticsearch pod logs shard failure, fix Elasticsearch unresponsive nodes, increase Elasticsearch JVM heap size Kubernetes, Elasticsearch performance tuning Kubernetes, Kubernetes Elasticsearch cluster health check, shard initialization error in Elasticsearch, Elasticsearch resource allocation best practices, resolve Elasticsearch shard allocation failed, Kubernetes Elasticsearch scaling guide, troubleshoot Elasticsearch pod not ready, Elasticsearch shard initialization troubleshooting steps',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Elasticsearch-Shard-Initialization-Failures-on-Kubernetes.html',
  },
};
