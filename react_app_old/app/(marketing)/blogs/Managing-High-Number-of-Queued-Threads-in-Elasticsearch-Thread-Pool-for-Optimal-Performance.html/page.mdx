...
export const metadata = {
  ...
  keywords:
    'Elasticsearch queued threads, Elasticsearch thread pool tuning, Elasticsearch performance optimization, fix high queued threads in Elasticsearch, Elasticsearch search thread pool issues, Elasticsearch thread pool configuration, Elasticsearch indexing performance tuning, reduce queued threads in Elasticsearch, Elasticsearch cluster performance issues, optimize Elasticsearch workload, Elasticsearch rejected requests fix, Elasticsearch slow search troubleshooting, Elasticsearch CPU memory tuning, Elasticsearch thread pool size best practices, Elasticsearch query performance improvement, Elasticsearch cluster scaling for performance, Elasticsearch monitoring best practices, Elasticsearch search performance optimization, Elasticsearch thread pool management, Elasticsearch high workload handling',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Managing-High-Number-of-Queued-Threads-in-Elasticsearch-Thread-Pool-for-Optimal-Performance.html',
  },
};
