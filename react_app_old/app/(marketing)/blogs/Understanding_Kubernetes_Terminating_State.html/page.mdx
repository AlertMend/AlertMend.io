...
export const metadata = {
  ...
  keywords:
    'Kubernetes pod stuck terminating, fix Kubernetes terminating pods, force delete Kubernetes pod, Kubernetes finalizers stuck, remove finalizer Kubernetes pod, Kubernetes pod won’t delete, troubleshooting Kubernetes terminating pods, Kubernetes volume detach issue, Persistent Volume unmount problem Kubernetes, Kubernetes storage stuck pod, kubectl delete pod force, Kubernetes SIGTERM handling, Kubernetes termination grace period, Kubernetes pod finalizer removal, Kubernetes node restart for stuck pod, Kubernetes liveness readiness probes, Kubernetes pod cleanup stuck, Kubernetes terminating state fix, Kubernetes pod termination troubleshooting, Kubernetes best practices pod termination',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Understanding_Kubernetes_Terminating_State.html',
  },
};
