...
export const metadata = {
  ...
  keywords:
    'Elasticsearch unassigned shards fix, troubleshoot Elasticsearch unassigned shards, Kubernetes Elasticsearch shard allocation issues, fix unassigned primary shards Elasticsearch, Elasticsearch shard assignment failure, Elasticsearch shard allocation troubleshooting Kubernetes, resolve unassigned replica shards Elasticsearch, Elasticsearch unassigned shards stuck, rebalance Elasticsearch shards Kubernetes, Elasticsearch pod eviction shard issues, Kubernetes Elasticsearch cluster health troubleshooting, fix Elasticsearch node unresponsive, Elasticsearch insufficient resources shard allocation, Elasticsearch shard reroute command, troubleshoot Elasticsearch cluster red yellow state, Elasticsearch pod logs unassigned shards, Elasticsearch shard recovery best practices, Kubernetes Elasticsearch performance tuning, Elasticsearch manual shard allocation, optimize Elasticsearch shard distribution Kubernetes',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Elasticsearch-Unassigned-Shards-Incident-on-Kubernetes.html',
  },
};
