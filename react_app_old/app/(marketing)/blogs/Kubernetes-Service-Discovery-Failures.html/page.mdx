...
export const blog = {
  ...
  image:
    "/img/blogs/Kubernetes Service Discovery Failures: Troubleshooting and Best Practices.png",
};
...
export const metadata = {
  ...
  keywords:
    'Kubernetes service discovery failures, troubleshoot Kubernetes service discovery, fix Kubernetes DNS issues, Kubernetes CoreDNS troubleshooting, Kubernetes service not reachable, Kubernetes DNS resolution failure, Kubernetes no endpoints for service, Kubernetes service configuration issues, Kubernetes network policy blocking traffic, Kubernetes readiness probe for services, Kubernetes service communication failure, Kubernetes service discovery best practices, Kubernetes CoreDNS performance monitoring, Kubernetes service endpoint troubleshooting, Kubernetes ClusterIP service issues, Kubernetes Headless service troubleshooting, Kubernetes internal DNS problems, Kubernetes service routing issues, Kubernetes microservices communication Kubernetes service discovery monitoring',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes-Service-Discovery-Failures.html',
  },
};
