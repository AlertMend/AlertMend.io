...
export const metadata = {
  ...
  description: blog.description,
   keywords:
    'Elasticsearch unassigned shards, fix unassigned shards Elasticsearch, Elasticsearch shard allocation failure, Elasticsearch Kubernetes troubleshooting, Elasticsearch node resource issues, rebalance Elasticsearch shards, unassigned shards Kubernetes, Elasticsearch pod eviction issues, Elasticsearch cluster performance, troubleshoot Elasticsearch unassigned shards, Elasticsearch reroute shards, Elasticsearch shard assignment, Elasticsearch Kubernetes performance optimization',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
    ...
    alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-for-Slow-Index-Flushing-Issues.html',
  },
};
