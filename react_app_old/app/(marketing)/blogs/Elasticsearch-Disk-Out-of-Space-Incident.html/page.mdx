...
export const metadata = {
  description: blog.description,
   keywords:
    'Elasticsearch disk out of space, Elasticsearch storage issues, fix Elasticsearch disk full, Elasticsearch shard allocation failure, Elasticsearch data retention policy, clear old indices Elasticsearch, Elasticsearch disk usage monitoring, Elasticsearch backup and restore, Elasticsearch scaling storage, Elasticsearch index cleanup, Elasticsearch disk space troubleshooting, Elasticsearch Kubernetes disk issue, Elasticsearch performance optimization',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
    ...
    alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-Disk-Out-of-Space-Incident.html',
  },
};
