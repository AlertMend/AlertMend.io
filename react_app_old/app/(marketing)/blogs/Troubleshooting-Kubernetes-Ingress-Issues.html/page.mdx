...
export const blog = {
  ...
  image:
    "/img/blogs/Troubleshooting Kubernetes Ingress Issues: Common Problems and Fixes.png",
};
...
export const metadata = {
  ...
  keywords:
    'Kubernetes Ingress troubleshooting, fix Kubernetes Ingress issues, Kubernetes Ingress not working, Kubernetes Ingress Controller down, Kubernetes Ingress DNS issues, Kubernetes Ingress SSL/TLS configuration, NGINX Ingress troubleshooting, Kubernetes Ingress service not reachable, Kubernetes Ingress misconfiguration fix, Kubernetes Ingress path routing issues, Kubernetes Ingress Controller logs, debug Kubernetes Ingress, Kubernetes Ingress class setup, Kubernetes Ingress health checks, Kubernetes Ingress best practices, Kubernetes Ingress SSL termination, Kubernetes Ingress DNS propagation fix, Kubernetes Ingress endpoints not found, Kubernetes Ingress common problems, Kubernetes Ingress Controller monitoring',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Kubernetes-Ingress-Issues.html',
  },
};
