...
export const metadata = {
  ...
  keywords:
    'EKubernetes DaemonSet troubleshooting, fix unhealthy Kubernetes DaemonSets, Kubernetes DaemonSet pods not scheduled, Kubernetes DaemonSet pending pods, Kubernetes DaemonSet deployment issues, Kubernetes DaemonSet best practices, Kubernetes node taints and tolerations, Kubernetes DaemonSet resource limits, Kubernetes DaemonSet pod logs, monitor Kubernetes DaemonSet health, Kubernetes DaemonSet scheduling issues, Kubernetes DaemonSet stuck pending, Kubernetes DaemonSet not deploying on all nodes, Kubernetes DaemonSet probes configuration, Kubernetes DaemonSet resource requests, Kubernetes DaemonSet pod failures, Kubernetes DaemonSet monitoring tools, troubleshoot Kubernetes DaemonSet pods, Kubernetes DaemonSet liveness readiness probes, Kubernetes DaemonSet node resource issues',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Unhealthy-Kubernetes-DaemonSets-A-Comprehensive-Guide.html',
  },
};
