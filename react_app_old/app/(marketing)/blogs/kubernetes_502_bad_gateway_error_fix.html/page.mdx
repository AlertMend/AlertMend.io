...
export const blog = {
  ...
  image:
    "/img/blogs/How to Troubleshoot and Fix Kubernetes 502 Bad Gateway Error.png",
};
...
export const metadata = {
  ...
  description: blog.description,
   keywords:
    'Kubernetes 502 Bad Gateway, Kubernetes 502 error fix, troubleshoot Kubernetes 502 error, Kubernetes Ingress 502, Kubernetes LoadBalancer 502, Kubernetes DNS issues, fix 502 Bad Gateway Kubernetes, Kubernetes service misconfiguration, Kubernetes CoreDNS troubleshooting, Kubernetes pod health check, Kubernetes readiness probe error, Kubernetes liveness probe issues, Kubernetes CrashLoopBackOff 502, Kubernetes network troubleshooting, Kubernetes firewall configuration error',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/kubernetes_502_bad_gateway_error_fix.html',
  },
};
