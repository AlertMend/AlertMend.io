...
export const blog = {
  ...
  image:
    "/img/blogs/Resolving Frequent Garbage Collection Issues in Elasticsearch for Better Performance.png",
};

export const metadata = {
  description: blog.description,
    keywords:
    'Elasticsearch garbage collection, Elasticsearch GC issues, fix frequent garbage collection Elasticsearch, Elasticsearch JVM tuning, optimize Elasticsearch heap size, Elasticsearch performance tuning, Elasticsearch memory optimization, troubleshoot Elasticsearch GC, Elasticsearch cluster stability, reduce GC pauses Elasticsearch, Elasticsearch JVM heap usage, Elasticsearch indexing performance, optimize Elasticsearch queries',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Frequent-Garbage-Collection-Issues-in-Elasticsearch-for-Better-Performance.html',
  },
};
