  ...
  return (
    ...
    >
      <Container className="flex  flex-col items-center justify-center">
        ...
        >
          Lightweight, simple, and affordable AI-powered on-call for small teams.
        </Heading>
         ...
         No enterprise bloat. No missed alerts, Just faster responses, happier engineers, and less downtime.
        </Subheading> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto relative z-10 my-12">
          <div className="flex items-center gap-3 text-base md:text-lg text-muted dark:text-muted-dark">
          ...
          <div className="flex items-center gap-3 text-base md:text-lg text-muted dark:text-muted-dark">
            <span className="text-green-500 font-bold flex-shrink-0">✔</span>
            Slack, Teams & Call integrations
          </div>
          <div className="flex items-center gap-3 text-base md:text-lg text-muted dark:text-muted-dark">
            <span className="text-green-500 font-bold flex-shrink-0">✔</span>
            Fair rotations, no burnout
          </div>
        </div>
