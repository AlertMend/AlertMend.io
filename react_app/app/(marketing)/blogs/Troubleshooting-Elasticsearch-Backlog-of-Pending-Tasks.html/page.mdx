...
export const blog = {
  ...
  image:
    "/img/blogs/Kubernetes StatefulSet Volume Recovery Issues: Troubleshooting and Best Practices.png",
};

export const metadata = {
  description: blog.description,
  keywords:
    'Kubernetes StatefulSet volume recovery, StatefulSet PVC recovery issues, fix Kubernetes volume mount failure, troubleshoot StatefulSet PVC pending, Kubernetes Persistent Volume recovery guide, StatefulSet pod volume attach fail, Kubernetes volume detachment issues, fix StatefulSet data corruption, Kubernetes StorageClass misconfiguration fix, StatefulSet volume not mounting, Kubernetes PV PVC troubleshooting, Kubernetes stateful application volume recovery, Kubernetes node resource constraints volumes, best practices for StatefulSet storage, StatefulSet persistent storage issues, Kubernetes PV stuck in pending state, Kubernetes volume backup and restore Velero, StatefulSet pod recovery from node failure, Kubernetes stateful workload troubleshooting, Kubernetes persistent volume best practices',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Elasticsearch-Backlog-of-Pending-Tasks.html',
  },
};
