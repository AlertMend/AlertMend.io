...
export const metadata = {
  ...
  keywords:
    'Kubernetes OOMKilled, Kubernetes exit code 137, OOMKilled troubleshooting, Kubernetes memory limits, Kubernetes memory leaks, OOMKilled causes, Kubernetes pod memory usage, node resource overcommitment, Kubernetes memory requests and limits, prevent OOMKilled, debug OOMKilled in Kubernetes, Kubernetes Vertical Pod Autoscaler, Kubernetes memory optimization',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
   ...
   alternates: {
    canonical: 'https://www.alertmend.io/blogs/Debugging-Kubernetes-OOMKilled-(Exit-Code-137)-Causes-and-Solutions.html',
  },
};
