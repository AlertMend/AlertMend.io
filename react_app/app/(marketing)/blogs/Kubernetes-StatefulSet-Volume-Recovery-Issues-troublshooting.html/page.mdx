...
export const metadata = {
  description: blog.description,
   keywords:
    'Kubernetes StatefulSet volume recovery, troubleshoot Kubernetes StatefulSet volumes, fix Kubernetes volume mount failure, Kubernetes Persistent Volume troubleshooting, Kubernetes PVC stuck in pending, Kubernetes volume detachment issues, Kubernetes StatefulSet storage issues, Kubernetes StatefulSet best practices, Kubernetes volume corruption recovery, Kubernetes StorageClass misconfiguration, Kubernetes stateful application troubleshooting, Kubernetes PVC and PV binding issues, Kubernetes persistent volume health monitoring, Kubernetes StatefulSet backup and restore, Kubernetes Velero volume backup, Kubernetes volume recovery testing, Kubernetes node resource constraints storage, Kubernetes database StatefulSet volume issues, Kubernetes storage backend troubleshooting',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes-StatefulSet-Volume-Recovery-Issues-troublshooting.html',
  },
};
