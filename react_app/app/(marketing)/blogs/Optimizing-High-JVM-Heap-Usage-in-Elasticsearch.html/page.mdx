...
export const blog = {
  ...
  image: "/img/blogs/Optimizing High JVM Heap Usage in Elasticsearch: Troubleshooting and Solutions.png",
};

export const metadata = {
  description: blog.description,
  keywords:
    'Elasticsearch high JVM heap usage, optimize Elasticsearch JVM heap, Elasticsearch heap memory troubleshooting, fix Elasticsearch heap usage 80%, Elasticsearch memory leak detection, Elasticsearch JVM heap tuning best practices, increase Elasticsearch heap size, Elasticsearch garbage collection optimization, Elasticsearch performance tuning, Elasticsearch heap monitoring commands, Elasticsearch query memory optimization, Elasticsearch aggregation memory usage, Elasticsearch JVM heap configuration guide, Elasticsearch memory usage troubleshooting, reduce Elasticsearch heap consumption, Elasticsearch heap overflow fix, Elasticsearch cluster heap size settings, Elasticsearch high memory usage causes, Elasticsearch JVM heap increase script, Elasticsearch memory optimization tips',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Optimizing-High-JVM-Heap-Usage-in-Elasticsearch.html',
  },
};
