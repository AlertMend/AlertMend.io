...
export const blog = {
  ...
  image:
    "/img/blogs/Kubernetes PersistentVolumeClaim (PVC) Guide: Basic Tutorial and Troubleshooting Tips.png",
};
...
export const metadata = {
  ...
  keywords:
    'Kubernetes PersistentVolumeClaim, Kubernetes PVC tutorial, Kubernetes PV and PVC guide, Kubernetes persistent storage, create PersistentVolume Kubernetes, create PVC Kubernetes, Kubernetes PV PVC binding, Kubernetes PVC troubleshooting, Kubernetes FailedAttachVolume, Kubernetes FailedMount, Kubernetes volume node affinity, Kubernetes reclaim policy, Kubernetes storage class tutorial, Kubernetes PVC best practices, Kubernetes PV lifecycle, Kubernetes storage management',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes_PersistentVolumeClaim_Guide.html',
  },
};
