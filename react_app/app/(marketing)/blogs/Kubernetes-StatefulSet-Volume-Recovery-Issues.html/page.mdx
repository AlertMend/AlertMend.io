...
export const blog = {
  ...
  image: "/img/blogs/Kubernetes StatefulSet Volume Recovery Issues: Troubleshooting and Best Practices.png",
};
export const metadata = {
  description: blog.description,
   keywords:
    'Kubernetes StatefulSet volume recovery, troubleshoot Kubernetes StatefulSet, fix Kubernetes volume mount issues, Kubernetes Persistent Volume troubleshooting, Kubernetes PVC stuck pending, Kubernetes volume detachment problems, Kubernetes StatefulSet storage errors, Kubernetes StorageClass misconfiguration, Kubernetes StatefulSet best practices, Kubernetes volume corruption fix, Kubernetes PV and PVC binding issues, Kubernetes persistent volume health check, Kubernetes StatefulSet backup strategy, Kubernetes Velero backup restore, Kubernetes volume recovery testing, Kubernetes node resource constraints storage, Kubernetes database StatefulSet recovery, Kubernetes storage backend configuration, Kubernetes stateful application troubleshooting',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes-StatefulSet-Volume-Recovery-Issues.html',
  },
};
