...
export const blog = {
  ...
  image:
    "/img/blogs/Troubleshooting Unhealthy Elasticsearch Nodes on Kubernetes: Causes and Solutions.png",
};
...
export const metadata = {
  ...
  keywords:
    'Elasticsearch unhealthy nodes, Elasticsearch node troubleshooting, Kubernetes Elasticsearch issues, Elasticsearch cluster health check, Elasticsearch node high CPU usage, Elasticsearch memory usage optimization, fix Elasticsearch unhealthy nodes, Elasticsearch pod CrashLoopBackOff, Elasticsearch Kubernetes troubleshooting, Elasticsearch cluster stability, Elasticsearch node resource contention, restart Elasticsearch node Kubernetes, scale Elasticsearch cluster Kubernetes, Elasticsearch node failure recovery, Elasticsearch network latency issues, Elasticsearch node replacement, Elasticsearch high heap memory usage, Elasticsearch performance tuning, Elasticsearch JVM optimization, Kubernetes Elasticsearch best practices',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Troubleshooting-Unhealthy-Elasticsearch-Nodes-on-Kubernetes.html',
  },
};
