...
export const metadata = {
  ...
  keywords:
    'Kubernetes Admission Webhooks, MutatingAdmissionWebhook, ValidatingAdmissionWebhook, Kubernetes webhook troubleshooting, Kubernetes webhook timeout, Kubernetes webhook certificate issue, API server webhook error, Kubernetes webhook best practices, fail-open fail-close webhook, Kubernetes webhook configuration',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Debugging-Kubernetes-Admission-Webhooks.html',
  },
};
