...
export const blog = {
  ...
  image:
    "/img/blogs/Optimizing Elasticsearch for High-Volume Indexing: Troubleshooting Delays and Failures.png",
};
...
export const metadata = {
  ...
  description: blog.description,
   keywords:
    'Elasticsearch high volume indexing, optimize Elasticsearch indexing speed, Elasticsearch bulk indexing best practices, Elasticsearch indexing performance tuning, Elasticsearch shard optimization, Elasticsearch bulk thread pool settings, Elasticsearch index refresh interval, Elasticsearch indexing delay fix, Elasticsearch indexing failures, Elasticsearch JVM heap optimization, Elasticsearch bulk API example, Elasticsearch cluster performance tuning, Elasticsearch indexing bottlenecks, fix Elasticsearch pending indexing, Elasticsearch high data ingestion optimization, Elasticsearch index settings for performance, Elasticsearch shard and replica configuration, Elasticsearch indexing troubleshooting, Elasticsearch thread pool saturation fix, Elasticsearch performance optimization guide',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Optimizing-Elasticsearch-for-High-Volume-Indexing.html',
  },
};
