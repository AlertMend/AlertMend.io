...
export const metadata = {
  ...
  keywords:
    'Elasticsearch high heap usage, Elasticsearch heap memory optimization, Elasticsearch JVM heap tuning, Elasticsearch memory leak troubleshooting, fix Elasticsearch heap usage 80%, Elasticsearch garbage collection tuning, Elasticsearch heap size configuration, optimize Elasticsearch memory performance, Elasticsearch JVM settings best practices, Elasticsearch indexing heap usage, reduce Elasticsearch heap consumption, Elasticsearch heap monitoring commands, Elasticsearch performance tuning, Elasticsearch high memory usage fix, Elasticsearch JVM heap increase, Elasticsearch GC optimization, Elasticsearch heap memory best practices, Elasticsearch cluster heap issues, Elasticsearch memory optimization guide, troubleshoot Elasticsearch heap size problems',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Optimizing-Elasticsearch-Heap-Memory.html',
  },
};
