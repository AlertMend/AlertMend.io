...
export const blog = {
  ...
  image:
    "/img/blogs/Mastering Kubernetes StatefulSets: Basics, Use Cases, and Debugging Tips.png",
};
...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Mastering-Kubernetes-StatefulSets-Basics-and-Debugging-Tips.html',
  },
};
