...
export const blog = {
  ...
  image:
    "/img/blogs/Elasticsearch Cluster Health Showing Red: Causes, Troubleshooting, and Solutions.png",
};
...
export const metadata = {
  ...
  keywords:
    'Elasticsearch caching issues, Elasticsearch query cache, Elasticsearch field data cache, Elasticsearch cache troubleshooting, clear Elasticsearch cache, Elasticsearch cache performance, query cache hits and misses, Elasticsearch slow queries, optimize Elasticsearch caching, Elasticsearch cache configuration, Elasticsearch cluster performance tuning, Elasticsearch cache size monitoring',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
    ...
    alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-Cluster-Health-Showing-Red.html',
  },
};
