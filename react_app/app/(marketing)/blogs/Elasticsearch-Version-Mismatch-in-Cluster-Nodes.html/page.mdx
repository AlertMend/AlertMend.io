...
export const metadata = {
  ...
  description: blog.description,
    keywords:
    'Elasticsearch version mismatch, fix Elasticsearch version mismatch, Elasticsearch node version issues, Elasticsearch cluster version drift, Elasticsearch upgrade troubleshooting, Elasticsearch Kubernetes version mismatch, synchronize Elasticsearch node versions, Elasticsearch version compatibility, Elasticsearch cluster stability, Elasticsearch update best practices, troubleshoot Elasticsearch node version',
  openGraph: {
    images: [blog.image],
  },
   twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Elasticsearch-Version-Mismatch-in-Cluster-Nodes.html',
  },
};
