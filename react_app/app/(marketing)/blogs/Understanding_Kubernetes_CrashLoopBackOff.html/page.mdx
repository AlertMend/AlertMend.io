...
export const blog = {
  ...
  image:
    "/img/blogs/Understanding and Troubleshooting Kubernetes CrashLoopBackOff.png",
};
...
export const metadata = {
  ...
  keywords:
    'Kubernetes CrashLoopBackOff troubleshooting, fix Kubernetes CrashLoopBackOff, CrashLoopBackOff pod error, CrashLoopBackOff Kubernetes causes, resolve CrashLoopBackOff issue, Kubernetes pod keeps restarting, Kubernetes pod crash loop, CrashLoopBackOff error Kubernetes fix, Kubernetes insufficient memory error, Kubernetes pod resource limits, Kubernetes deployment errors, Kubernetes DNS issues, Kubernetes pod missing dependencies, Kubernetes pod logs analysis, Kubernetes pod restart policy, CrashLoopBackOff prevention, Kubernetes memory leak troubleshooting, monitor Kubernetes pods, Kubernetes Prometheus Grafana monitoring, Kubernetes pod optimization',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Understanding_Kubernetes_CrashLoopBackOff.html',
  },
};
