...
export const metadata = {
  ...
  keywords:
    'Slack integration Alertmend, connect Slack with Alertmend, Slack incident alert integration, Slack real-time alerts setup, Slack app token guide, get Slack channel ID, Slack app installation guide, Slack API integration for alerts, Alertmend Slack setup tutorial, Slack OAuth token generation, Slack workspace integration steps, Slack channel integration for alerts, generate Slack app-level token, Slack integration best practices, retrieve Slack channel ID, add app to Slack channel, Slack automated alert integration, Slack app scopes for Alertmend, Slack bot integration guide, Slack monitoring alerts',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/slack-integration',
  },
};
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
  <img
    ...
    style={{ width: '60%', height: '500px', objectFit: 'contain', borderRadius: '1px' }}
  />
</div>
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
  <img
    ...
    alt="Pod Creation Lifecycle"
    style={{ width: '60%', height: '500px', borderRadius: '1px' }}
  />
</div>
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
  <img
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
  <img
    ...
    alt="Pod Creation Lifecycle"
    style={{ width: '60%', height: '400px', borderRadius: '1px' }}
  />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
  <img
    ...
    alt="Pod Creation Lifecycle"
    style={{ width: '70%', height: '500px',borderRadius: '1px' }}
  />
</div>
