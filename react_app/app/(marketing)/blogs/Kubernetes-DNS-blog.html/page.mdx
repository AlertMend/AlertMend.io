...
export const metadata = {
  ...
  description: blog.description,
   keywords:
    'Kubernetes DNS, Kubernetes DNS troubleshooting, Kubernetes service discovery, fix Kubernetes DNS resolution failure, Kubernetes CoreDNS issues, Kubernetes DNS best practices, Kubernetes DNS caching, NodeLocal DNS cache Kubernetes, Kubernetes DNS performance monitoring, Kubernetes CoreDNS configuration, Kubernetes DNS resolution inside pods, Kubernetes CoreDNS metrics, fix CoreDNS latency, Kubernetes DNS optimiz',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes-DNS-blog.html',
  },
};
