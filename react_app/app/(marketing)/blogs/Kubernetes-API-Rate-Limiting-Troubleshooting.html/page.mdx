...
export const blog = {
  ...
  image:
    "/img/blogs/Kubernetes API Rate Limiting Troubleshooting: Solving Performance Bottlenecks.png",
};
...
export const metadata = {
  ...
  keywords:
    'Kubernetes API rate limiting, Kubernetes API throttling, troubleshoot Kubernetes API performance, Kubernetes API server tuning, Kubernetes API request limit, fix Kubernetes rate limiting, optimize Kubernetes API calls, Kubernetes max-requests-inflight, Kubernetes client QPS burst, Kubernetes API performance bottlenecks, Kubernetes API scaling, reduce Kubernetes API requests, Kubernetes probe optimization, Kubernetes API caching, Kubernetes API audit logging',
  openGraph: {
    images: [blog.image],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.alertmend.io/blogs/Kubernetes-API-Rate-Limiting-Troubleshooting.html',
  },
};
