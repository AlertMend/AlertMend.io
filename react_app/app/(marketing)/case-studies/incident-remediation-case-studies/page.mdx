...
export const caseStudy = {
  ...
  { title: "Alert Trigger", href: "#alert-trigger" },
  { title: "Validation via Logs", href: "#validation-via-logs" },
  { title: "Automated Remediation", href: "#automated-remediation" },
  { title: "Post-Restart Health Check", href: "#post-restart-health-check" },
