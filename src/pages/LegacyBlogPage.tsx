 ...
 * Renders the blog post content with canonical URL pointing to /blog/:slug
 */
export default function LegacyBlogPage() {
  ...
  // Canonical URL always points to the preferred format (/blog/:slug)
  const canonicalUrl = `/blog/${canonicalSlug}`
    ...
    <div className="min-h-screen bg-white">
      <SEO
        ...
        structuredData={{
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": `https://www.alertmend.io${canonicalUrl}`
          },
