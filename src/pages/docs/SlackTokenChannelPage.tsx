...
<h1 className="text-4xl md:text-5xl font-black text-brand-900 mb-4">
            ...
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl font-bold text-brand-900 mt-8 mb-4">Getting Your Slack Bot Token</h2>
              
              <h3 className="text-xl font-bold text-brand-900 mt-6 mb-3">Method 1: Using Slack App (Recommended)</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
                <li>Go to <a href="https://api.slack.com/apps" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">api.slack.com/apps</a></li>
              ...
              <h3 className="text-xl font-bold text-brand-900 mt-6 mb-3">Method 2: Using Legacy Token (Not Recommended)</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
                <li>Visit <a href="https://api.slack.com/custom-integrations/legacy-tokens" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">Legacy Token Generator</a></li>
              ...
              <h2 className="text-2xl font-bold text-brand-900 mt-8 mb-4">Getting Your Channel ID</h2>
              
              <h3 className="text-xl font-bold text-brand-900 mt-6 mb-3">Method 1: From Slack Desktop/Web App</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
              ...
              <h3 className="text-xl font-bold text-brand-900 mt-6 mb-3">Method 2: Using Slack API</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
              ...
              <h3 className="text-xl font-bold text-brand-900 mt-6 mb-3">Method 3: From Channel URL</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
