            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mt-8">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border-2 border-brand-200/50 hover:border-brand-400 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-brand-50/0 via-brand-100/0 to-brand-200/0 group-hover:from-brand-50/50 group-hover:via-brand-100/30 group-hover:to-brand-200/20 transition-all duration-500 rounded-2xl"></div>
                    
                    <div className="relative z-10">
                      <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-brand-50 text-brand-600 mb-5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-md">
                        <Icon className="h-7 w-7" />
                      </div>
                      <h3 className="text-xl font-bold text-brand-900 mb-3 group-hover:text-brand-800 transition-colors">{value.title}</h3>
        ...
        <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden gradient-bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-900 mb-6 leading-tight">
                Meet the Founders
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto mt-8">
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border-2 border-brand-200/50 hover:border-brand-400 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-brand-50/0 via-brand-100/0 to-brand-200/0 group-hover:from-brand-50/50 group-hover:via-brand-100/30 group-hover:to-brand-200/20 transition-all duration-500 rounded-2xl"></div>
                
                <div className="relative z-10">
                  {/* Avatar Image */}
                  <div className="w-28 h-28 mx-auto mb-6 rounded-full overflow-hidden border-4 border-brand-200 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.className = 'w-28 h-28 mx-auto mb-6 rounded-full bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center text-white text-3xl font-bold shadow-xl group-hover:scale-110 transition-transform duration-300'
                  ...
                  <h3 className="text-2xl font-bold text-brand-900 mb-3 group-hover:text-brand-800 transition-colors">Arvind Rajpurohit</h3>
                  <p className="text-brand-600 font-semibold mb-6">Co-Founder & CEO</p>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-brand-600 to-brand-700 !text-white rounded-lg font-semibold hover:from-brand-700 hover:to-brand-800 transition-all shadow-md hover:shadow-lg hover:scale-105"
                  >
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border-2 border-brand-200/50 hover:border-brand-400 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-brand-900 mb-3 group-hover:text-brand-800 transition-colors">Dinesh Agrawal</h3>
        ...
        <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10 max-w-6xl mx-auto mt-8">
              {/* Advisor 1 - Mike */}
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 border-2 border-brand-200/50 hover:border-brand-400 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-brand-50/0 via-brand-100/0 to-brand-200/0 group-hover:from-brand-50/50 group-hover:via-brand-100/30 group-hover:to-brand-200/20 transition-all duration-500 rounded-2xl"></div>
                
                <div className="relative z-10">
                  {/* Avatar Placeholder */}
                  <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center text-white text-2xl font-bold shadow-xl group-hover:scale-110 transition-transform duration-300">
                    MJ
                  </div>
                  
                  <h3 className="text-xl font-bold text-brand-900 mb-3 group-hover:text-brand-800 transition-colors">Mike</h3>
                  <p className="text-brand-600 font-semibold mb-4">Advisor</p>
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 border-2 border-brand-200/50 hover:border-brand-400 hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-brand-900 mb-3 group-hover:text-brand-800 transition-colors">Erik</h3>
                  <p className="text-brand-600 font-semibold mb-4">Mentor</p>
