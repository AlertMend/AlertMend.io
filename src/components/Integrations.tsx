...
const integrations = [
  { name: 'Slack', logo: '/logos/Slack_logo.png', icon: null, color: 'text-brand-600', bg: 'bg-white' }, // ✓ Logo exists
  { name: 'PagerDuty', logo: '/logos/pagerduty-logo.svg', icon: Bell, color: 'text-brand-600', bg: 'bg-white' }, // ✓ Logo exists
  ...
  { name: 'Datadog', logo: '/logos/datadog-logo.svg', icon: null, color: 'text-brand-600', bg: 'bg-white' }, // ✓ Logo exists
  { name: 'Alertmanager', logo: null, icon: Bell, color: 'text-orange-600', bg: 'bg-white' }, // Uses icon fallback (logo file doesn't exist)
  { name: 'AWS ECS', logo: '/logos/ecs-logo.png', icon: null, color: 'text-brand-600', bg: 'bg-white' }, // ✓ Logo exists
    ...
    <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden gradient-bg-purple">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <div className="inline-block px-5 py-2 bg-brand-800/50 backdrop-blur-sm text-brand-200 rounded-full text-sm font-bold mb-5 shadow-lg border border-brand-700/50">
            Integrations
          </div>
