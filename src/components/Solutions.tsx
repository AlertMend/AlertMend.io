...
export default function Solutions() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      hoverBg: 'from-brand-50/60 via-brand-100/40 to-brand-200/30',
      features: [
  ...
  return (
    <section id="solutions" className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden gradient-bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-40 w-96 h-96 bg-brand-100/20 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-brand-50 via-brand-100 to-brand-50 text-brand-700 rounded-full text-sm font-bold mb-5 shadow-lg backdrop-blur-sm border border-brand-200/50">
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              <div
                ...
                className="group relative bg-white/80 backdrop-blur-xl rounded-2xl p-6 lg:p-7 border-2 border-gray-200/50 hover:border-brand-300/80 hover:shadow-xl transition-all duration-300 flex flex-col cursor-pointer overflow-hidden"
                style={{ 
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mb-3 flex-grow">
                    <h3 className="text-lg md:text-xl font-bold text-brand-900 mb-2 group-hover:text-brand-900 transition-colors leading-tight">
                      {solution.title}
                    </h3>
                  ...
                  <div className="pt-3 border-t border-gray-200/50 mb-3">
                    <div className="grid grid-cols-2 gap-2.5">
                      {solution.metrics.map((metric, idx) => (
                        <div 
                          key={idx} 
                          className="text-center p-2.5 rounded-lg bg-gradient-to-br from-gray-50 to-white group-hover:from-brand-50/50 group-hover:to-white transition-all duration-300 border border-gray-100"
                        >
                  ...
                  <div className="mt-auto">
                    <div className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-brand-50 to-brand-100/50 rounded-lg border border-brand-200/50 group-hover:from-brand-100 group-hover:to-brand-200/50 group-hover:border-brand-300/80 transition-all duration-300">
                      <span className="text-xs font-bold text-brand-800 group-hover:text-brand-900 transition-colors">
                        Learn More
                      </span>
                      <ArrowRight className="h-4 w-4 text-brand-700 group-hover:translate-x-1 group-hover:text-brand-900 transition-all duration-300" />
                    </div>
                  </div>
                </div>
              </div>
