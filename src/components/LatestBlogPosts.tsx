 ...
 *
 * Lives on legacy pages (older marketing routes still use the original
 * `LatestBlogPosts` block). Re-skinned to match the new homepage's
 * near-black + zinc + single-violet system so the legacy pages don't
 * fight with the redesigned homepage chrome.
 */
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 bg-zinc-950 text-white px-7 py-3 rounded-lg font-semibold hover:bg-zinc-900 transition-colors shadow-[0_1px_2px_rgba(9,9,11,0.16)] hover:shadow-[0_4px_12px_-4px_rgba(9,9,11,0.24)]"
          >
            View All Blog Posts
